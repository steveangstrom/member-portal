...
// if is not logged in show them a different thing ... not done yet 
	...
	if( $slug =='learning-portal'){
		
		 if ( !is_user_logged_in() ) {
			 $content = '<h2>Please sign in to the Learning Portal</h2>';
...
echo('</pre>');*/
		...
		pher_show_error_messages();
			...
			if(!empty($usermeta['first_name'][0])){
				$content = '<h2>Hi '.$usermeta['first_name'][0].',<br>Welcome to the learning portal</h2>'.$content;
			}else{
